...
// Config defines the top level configuration for a bdc node
type Config struct {
...
// DefaultConfig returns a default configuration for a bdc node
...
// BaseConfig defines the base configuration for a bdc node
type BaseConfig struct {
	...
	// TCP or UNIX socket address for bdc to listen on for
	// connections from an external PrivValidator process
	PrivValidatorListenAddr string `mapstructure:"priv_validator_laddr"`

	// TCP or UNIX socket address of the ABCI application,
	// or the name of an ABCI application compiled in with the bdc binary
...
// DefaultBaseConfig returns a default base configuration for a bdc node
...
// TestBaseConfig returns a base configuration for testing a bdc node
func TestBaseConfig() BaseConfig {
	cfg := DefaultBaseConfig()
	cfg.chainID = "bdc_test"
...
// RPCConfig defines the configuration options for the bdc RPC server
...
// P2PConfig defines the configuration options for the bdc peer-to-peer networking layer
...
// MempoolConfig defines the configuration options for the bdc mempool
...
// DefaultMempoolConfig returns a default configuration for the bdc mempool
...
// TestMempoolConfig returns a configuration for testing the bdc mempool
...
// ConsensusConfig defines the confuguration for the bdc consensus service,
