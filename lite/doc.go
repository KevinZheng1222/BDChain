...
bdc RPC exposes a lot of info, but a malicious node
...
with any bdc node, just the validator set as a whole.
...
client.NewHTTPProvider - query bdc rpc.
...
github issue (https://github.com/bdc/bdc/issues/377).
