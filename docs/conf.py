# -*- coding: utf-8 -*-
#
# bdc documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'bdc.tex', u'bdc Documentation',
...
man_pages = [
    (master_doc, 'bdc', u'bdc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'bdc', u'bdc Documentation',
     author, 'bdc', 'Byzantine Fault Tolerant Consensus.',
     'Database'),
]

# ---- customization -------------------------

tools_repo = "https://raw.githubusercontent.com/bdc/tools/"
tools_branch = "master"
...
urllib.urlretrieve('https://raw.githubusercontent.com/bdc/tools/master/tm-monitor/README.rst', filename='tools/monitoring.rst')

#### abci spec #################################

abci_repo = "https://raw.githubusercontent.com/bdc/abci/"
abci_branch = "develop"
