...
Its code can be found `here <https://github.com/bdc/abci/blob/master/cmd/abci-cli/abci-cli.go>`__ and looks like:
...
Golang <https://github.com/bdc/abci/tree/master/server>`__. See
...
Like the kvstore app, its code can be found `here <https://github.com/bdc/abci/blob/master/cmd/abci-cli/abci-cli.go>`__ and looks like:
...
`example directory <https://github.com/bdc/abci/tree/master/example`__).
...
to add you to our `ecosystem <https://bdc.com/ecosystem>`__!
We're also offering `bounties <https://bdc.com/bounties>`__ for
implementations in new languages!

The ``abci-cli`` is designed strictly for testing and debugging. In a
real deployment, the role of sending messages is taken by bdc,
...
app with bdc, see the `getting started
