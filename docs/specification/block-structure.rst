...
The bdc consensus engine records all agreements by a
...
A
`Block <https://godoc.org/github.com/bdc/bdc/types#Block>`__
contains:

-  a `Header <#header>`__ contains merkle hashes for various chain
   states
-  the
   `Data <https://godoc.org/github.com/bdc/bdc/types#Data>`__
...
The
`Header <https://godoc.org/github.com/bdc/bdc/types#Header>`__
...
bdc RPC, in order to display or process the new transactions you
...
`Validators <https://godoc.org/github.com/bdc/bdc/types#Validator>`__.
...
validators <https://godoc.org/github.com/bdc/bdc/types#ValidatorSet.Hash>`__
to see if there have been changes.

The ``AppHash`` serves as the basis for validating any merkle proofs
that come from the `ABCI
application <https://github.com/bdc/abci>`__. It represents the
...
The
`Commit <https://godoc.org/github.com/bdc/bdc/types#Commit>`__
contains a set of
`Votes <https://godoc.org/github.com/bdc/bdc/types#Vote>`__
...
`light-client <https://github.com/bdc/light-client>`__ package.
...
``genesis.json`` from *bdc*, not the ``genesis.json`` from the
...
bytes <https://godoc.org/github.com/bdc/bdc/types#Vote.WriteSignBytes>`__
using the chainID and a `nice helper
function <https://godoc.org/github.com/bdc/bdc/types#SignBytes>`__,
...
The `block
hash <https://godoc.org/github.com/bdc/bdc/types#Block.Hash>`__
...
`ABCI <https://github.com/bdc/abci>`__ application to accept or
reject transactions.
...
`BlockID <https://godoc.org/github.com/bdc/bdc/types#BlockID>`__,
...
The
`PartSetHeader <https://godoc.org/github.com/bdc/bdc/types#PartSetHeader>`__
contains the total number of pieces in a
`PartSet <https://godoc.org/github.com/bdc/bdc/types#PartSet>`__,
