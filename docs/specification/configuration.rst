...
bdc Core can be configured via a TOML file in
...
The default configuration file create by ``bdc init`` has all
the parameters set with their default values. It will look something
like the file below, however, double check by inspecting the
``config.toml`` created with your version of ``bdc`` installed:
