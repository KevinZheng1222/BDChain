...
bdc aims to encode data structures in a manner similar to how the corresponding Go structs
...
See https://github.com/bdc/go-wire/tree/sdk2.
...
Simple Merkle trees are used in numerous places in bdc to compute a cryptographic digest of a data structure.
