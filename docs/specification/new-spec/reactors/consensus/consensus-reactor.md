...
manages the state of the bdc consensus internal state machine. 
...
Consensus State handles execution of the bdc BFT consensus algorithm. It processes votes and proposals, 
