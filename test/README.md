...
Running the integrations test will build a docker container with local version of bdc
...
- persistence tests
	- crash bdc at each of many predefined points, restart, and ensure it syncs properly with the app
- p2p tests
