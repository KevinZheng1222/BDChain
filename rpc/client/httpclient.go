...
func (w *WSEvents) Subscribe(ctx context.Context, subscriber string, query tmpubsub.Query, out chan<- interface{}) error {
	...
	w.mtx.Lock()
	// subscriber param is ignored because bdc will override it with
	// remote IP anyway.
