...
bdc RPC is built using [our own RPC library](https://github.com/bdc/bdc/tree/master/rpc/lib). Documentation and tests for that library could be found at `bdc/rpc/lib` directory.
...
The first entry in the result-array (`96`) is the method this response correlates with. `96` refers to "ResultTypeBroadcastTx", see [responses.go](https://github.com/bdc/bdc/blob/master/rpc/core/types/responses.go) for a complete overview.
