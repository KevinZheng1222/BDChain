...
import (
	...
	rpctypes "github.com/bdc/bdc/rpc/lib/types"
	tmtypes "github.com/bdc/bdc/types"
	tmquery "github.com/bdc/tmlibs/pubsub/query"
)
...
//
// bdc provides a few predefined keys: tm.event, tx.hash and tx.height.
...
// https://godoc.org/github.com/bdc/bdc/types#pkg-constants
//
// For complete query syntax, check out
// https://godoc.org/github.com/bdc/tmlibs/pubsub/query.
//
// ```go
// import "github.com/bdc/tmlibs/pubsub/query"
// import "github.com/bdc/bdc/types"
//
