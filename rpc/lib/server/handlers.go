...
import (
	...
	types "github.com/bdc/bdc/rpc/lib/types"
...
// To be properly decoded the arg must be a concrete type from bdc (if its an interface).
...
// If some writes don't set it while others do, they may timeout incorrectly (https://github.com/bdc/bdc/issues/553)
